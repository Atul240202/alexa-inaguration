...
function audioplay(){
    ...
    if(value == 0|| value == 20 || value == 40){
        var music = new Audio("screen"+value+".mp3")
        console.log("Audio error"+ value)
        music.play()
        old_music=music
    }
    // if (ctr!=0){
    //     var music = new Audio("screen"+ctr+".mp3");
    //     music.play();
    // }
    // else{
    // console.log("Audio error"+ ctr + value);
    // }
